...
section text",
        expect![[r#"
            ...
            ((13, 16), Ident)
            lines:
            (Section((8, 12)), (0, 1), (0, 0), None)
            (Section((8, 11)), (1, 1), (0, 0), None)
            (Section((8, 12)), (1, 1), (0, 0), None)"#]],
    );
}
#[test]
fn decimal() {
...
fn hello_world() {
    check(
        ...
        expect![[r#"
            ...
            ((19, 22), Ident)
            lines:
            (Section((10, 14)), (0, 0), (0, 0), None)
            (Variable((4, 11), (12, 14)), (0, 2), (0, 0), Some((35, 64)))
            (Empty, (2, 2), (0, 0), None)
            (Section((10, 14)), (2, 2), (0, 0), None)
...
fn print_any() {
    check(
        ...
        expect![[r#"
            ...
            (Variable((4, 7), (8, 10)), (28, 29), (0, 0), None)
            (Instruction((4, 7)), (29, 31), (0, 0), None)
            (Instruction((4, 7)), (31, 32), (0, 0), None)
            (Empty, (32, 32), (0, 0), None)
            (Instruction((4, 7)), (32, 34), (0, 0), None)
            (Instruction((4, 7)), (34, 36), (0, 0), None)
            (Instruction((4, 7)), (36, 37), (0, 0), None)
            (Instruction((4, 7)), (37, 39), (0, 0), None)
            (Instruction((4, 11)), (39, 39), (0, 0), None)
            (Empty, (39, 39), (0, 0), None)
            (Instruction((4, 7)), (39, 39), (0, 0), None)"#]],
    );
}
