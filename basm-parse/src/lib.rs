...
pub fn comment(input: Span) -> IResult<Span, Option<Span>> {
    opt(space0_then(recognize(pair(tag(";"), many0(anychar)))))(input)
}
...
// pub fn instruction(input: Span) -> IResult<Span, (Span, Vec<Value>)> {
//     spaced(tuple((identifier, values)))(input)
// }
// pub fn nullary(input: Span) -> IResult<Span, Span> {
//     spaced(identifier)(input)
// }
// pub fn unary(input: Span) -> IResult<Span, (Span, Span)> {
//     spaced(tuple((identifier, space1_then(identifier))))(input)
// }
// pub fn binary(input: Span) -> IResult<Span, (Span, Span, Span)> {
//     spaced(tuple((
//         identifier,
//         space1_then(identifier),
//         preceded(space0_then(tag(",")), space1_then(identifier)),
//     )))(input)
// }
